...
CREATE TABLE IF NOT EXISTS appeals (
    ...
    CONSTRAINT fk_appeals_assignee FOREIGN KEY (assignee_id) REFERENCES users(id) ON DELETE
    SET
        NULL,
        CONSTRAINT fk_appeals_department FOREIGN KEY (department_id) REFERENCES departments(id) ON DELETE
    SET
        NULL,
